...
class DoADistEst(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "DoA&DistEst")
        ...
        self.uhd_usrp_source_0_0.set_center_freq(f_mod, 0)
        self.uhd_usrp_source_0_0.set_gain(RF_Gain, 0)
        ...
        self.epy_block_1 = epy_block_1.blk(nsamples=nsamples, comparation_level=1.3, tolerance=0.9)
        ...
        self.band_pass_filter_0_1_1 = filter.fir_filter_ccf(
            1,
            firdes.band_pass(
                1,
                samp_rate,
        ...
        self.connect((self.band_pass_filter_0_1, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        self.connect((self.band_pass_filter_0_1_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.band_pass_filter_0_1_1, 0), (self.blocks_complex_to_mag_squared_0_1, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.epy_block_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_mag_squared_0_1, 0), (self.blocks_moving_average_xx_0_0, 0))
        ...
        self.connect((self.blocks_null_source_0, 0), (self.epy_block_1, 1))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_add_xx_0_0, 1))
        self.connect((self.epy_block_0_0, 0), (self.epy_block_1, 2))
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.band_pass_filter_0_1_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.band_pass_filter_0_1_1, 0))
    ...
    def set_f_mod(self, f_mod):
        ...
        self.uhd_usrp_source_0_0.set_center_freq(self.f_mod, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0_1.set_taps(firdes.band_pass(1, self.samp_rate, 300e3, 500e3, 100e3, firdes.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_1_0.set_taps(firdes.band_pass(1, self.samp_rate, 300e3, 500e3, 100e3, firdes.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_1_1.set_taps(firdes.band_pass(1, self.samp_rate, 300e3, 500e3, 25e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_nsamples(self, nsamples):
        ...
        self.epy_block_1.nsamples = self.nsamples
    ...
    def set_RF_Gain(self, RF_Gain):
        ...
        self.uhd_usrp_source_0_0.set_gain(self.RF_Gain, 0)





def main(top_block_cls=DoADistEst, options=None):
    tb = top_block_cls()
